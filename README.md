...
Semplice esempio di utilizzo MVC framework in PHP.


## Configurazione

Il File di configurazione è situato in [App/Config.php](App/Config.php) class. 
Di Default include la connessione al database e la possibilità di mostrare o nascondere il dettaglio degli errori. E' possibile accedere alle impostazioni tramite : `Config::DB_HOST`. Qui è possibile accedere e inserire le proprie impostazioni.
